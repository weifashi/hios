...
func (t pushTask) pushWriteMessage(v interfaces.WsClient, msgJSON []byte) {
	...
	if v.Conn != nil && v.Conn.UnderlyingConn() != nil {
		...
		logger.SetLogger(fmt.Sprintf(`{"File":{"filename":"./%s/logs/wss.log","level":"TRAC","daily":true,"maxlines":100000,"maxsize":10,"maxdays":3,"append":true,"permit":"0660"}}`, config.WorkDir))
